...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const nombre = params.get('name') || 'Eduardo';
    ...
    parrafo.textContent = "Que esta Navidad esté llena de amor, alegría y momentos inolvidables. Gracias por los momentos especiales que hemos compartido. ¡Te deseo unas fiestas mágicas y un feliz año nuevo lleno de bendiciones y alegrias! ¡Feliz Navidad! Atte, Eduardo";
